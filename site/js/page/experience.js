...
const HAIRO_CONTENT = {
    ...
    period: "2022.04",
    experience: {
        "Backend": `Design and the implementation of whole backend, from scratch. Used technologies/paradigms: Java 17, modular monolith, <a href="https://www.jooq.org/">JOOQ</a>, PostgreSQL, RabbitMQ, WebRTC, WebSockets and Web Push Notifications.
        <br>
        Writing lots of unit and integration tests using <a href="https://www.testcontainers.org/">Testcontainers</a>.`,
        "Infrastructure": `Design and the implementation of a custom infrastructure. It was build on <a href="https://digitalocean.com">DigitalOcean</a>, using Docker and Python/Bash scripts.
...
const HYCOM_CONTENT = {
    ...
    experience: {
        "Data Lake": `Creating and modifying apps that consume data from various resources, do some sort of processing with it and/or send/store it.
         ...
         Due to heavy usage of time series data, we later on switched from RDS to customized <a href="https://www.timescale.com/">TimescaleDb</a> instance, deployed on EC2.
        ...
        "DevOps": `<del>Taking care and improving existing CI/CD infrastructure. 
            It was based on Jenkins and used host of Bash, Python, SQL and Ansible scripts.</del> 
            We rewrote CI/CD system from scratch, using combination of Python scripts and AWS's CodeBuild service, automating everything that could be automated.
            Due to growing number of applications and limited team size, we also decided to automate (as much as possible) maintenance and monitoring.
            Our custom monitoring system was based on: <a href="https://grafana.com/">Grafana</a>, Elasticsearch, CloudWatch and dedicated Python application.`
    }
};
...
const INOVATICA_CONTENT = {
    ...
    experience: {
        ...
        "Algorithms": `Participating in the autonomous forklift project, I had the opportunity to work on fascinating problems. 
            One of them was about creating a safety system, that allowed a forklift to firstly slow down and then stop, if detected obstacle is too close.
