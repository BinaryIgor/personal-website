...
const LANGUAGES_CONTENT = {
    ...
    "JavaScript": `I used it for frontend, web development and by playing with Node.js.
    ...
    "Assembly": `I have also played with Assembly to have a better grasp of what is really going on on the lowest, machine level. 
        ...
        Most importantly, it destroys <a href="https://blog.cleancoder.com/uncle-bob/2015/08/06/LetTheMagicDie.html">the magic</a> and gives confidence of understanding.</a>
...
const TECHNOLOGIES_CONTENT = {
    ...
    "AWS": `Participating in the creation of a data lake at Hycom gave me a chance to use various AWS services.
        ...
        Using CodeBuild, <a href="https://aws.amazon.com/cdk">CDK</a> and a host of Python scripts, we created a CI/CD system customized to our GitFlow approach.`
};

const OTHER_CONTENT = {
    "HTTP": `Creating a simple <a href="${Repositories.brightServer}">server</a> and using it from both <a href="${Repositories.gentleRequest}">client</a> and server side made me well versed with this protocol.`,
